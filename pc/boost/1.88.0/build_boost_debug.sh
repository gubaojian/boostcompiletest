...
DOWNLOAD_FILE=boost_1_88_0.tar.gz
DOWNLOAD_URL="https://archives.boost.io/release/${VERSION}/source/boost_1_88_0.tar.gz"
UNZIP_DIR=boost_1_88_0
uname -a
